...
- Go to the [GitHub interface for releasing](https://github.com/meilisearch/gatsby-plugin-meilisearch/releases): on this page, click on `Draft a new release`.
...
GitHub Actions will be triggered and push the beta version to [npm](https://www.npmjs.com/package/gatsby-plugin-meilisearch).
